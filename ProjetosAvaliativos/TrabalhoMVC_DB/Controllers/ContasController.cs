...
namespace TrabalhoMVC_DB.Controllers
{
    public class ContasController : Controller
    {
        private readonly appContext _context;

        public ContasController(appContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Vencimento,Valor")] Conta conta)
        {
            if (id != conta.Id)
            {
                return NotFound();
